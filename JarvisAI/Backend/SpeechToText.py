...
# Get get the input language settings form the environment variables.
...
# initialize the chrome webdriver using chrome Driver manger.
...
def QueryModifier(Query):
    ...
    # Check the query if question add a question mark if nesccesory.
...
# Function to peerform a speech recognition using the webdriver.
def SpeechRecognition():
    # Open the Html file in the browser.
    driver.get("file:///" + Link)
    # Start recognition by clicking on the start button.
    driver.find_element(by=By.ID, value="start").click()
    
    while True:
        try:
           # Get the rocognized text from the Html output element.
           Text = driver.find_element(by=By.ID, value="output").text
           
           if Text:
               # stop recogition by clicking the stop button.
               ...
               if InputLanguage.lower() == "en" or "en" in InputLanguage.lower():
                   ...
                   # if the input lang is not en translate the text and return it .
